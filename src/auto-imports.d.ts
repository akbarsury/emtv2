...
export {}
declare global {
  const Analytics: typeof import('./firebase/Config')['Analytics']
  const AppDB: typeof import('./firebase/AppDB')['AppDB']
  const AppStorage: typeof import('./firebase/AppStorage')['AppStorage']
  const AppStore: typeof import('./stores/AppStore')['default']
  const Authentication: typeof import('./firebase/Config')['Authentication']
  const Delta: typeof import('@vueup/vue-quill')['Delta']
  const EffectScope: typeof import('vue')['EffectScope']
  const Firestore: typeof import('./firebase/Config')['Firestore']
  const GoogleAuthProvider: typeof import('firebase/auth')['GoogleAuthProvider']
  const ImageUploader: typeof import('quill-image-uploader')['ImageUploader']
  const Quill: typeof import('@vueup/vue-quill')['Quill']
  const QuillDeltaToHtmlConverter: typeof import('quill-delta-to-html')['QuillDeltaToHtmlConverter']
  const UserStore: typeof import('./stores/UserStore')['default']
  const addDoc: typeof import('firebase/firestore')['addDoc']
  const appAuth: typeof import('./firebase/AppAuth')['appAuth']
  const arrayRemove: typeof import('firebase/firestore')['arrayRemove']
  const arrayUnion: typeof import('firebase/firestore')['arrayUnion']
  const asyncComputed: typeof import('@vueuse/core')['asyncComputed']
  const autoResetRef: typeof import('@vueuse/core')['autoResetRef']
  const base64: typeof import('@hexagon/base64')['base64']
  const browserSessionPersistence: typeof import('firebase/auth')['browserSessionPersistence']
  ...
  const fileDialog: typeof import('file-dialog')['fileDialog']
  const getContents: typeof import('@vueup/vue-quill')['getContents']
  ...
  const onAuthStateChanged: typeof import('firebase/auth')['onAuthStateChanged']
  ...
  const promptForUserCredentials: typeof import('firebase/auth')['promptForCredentials']
  const provide: typeof import('vue')['provide']
  const query: typeof import('firebase/firestore')['query']
  const quillModules: typeof import('./helpers/Quill')['quillModules']
  const quillOptions: typeof import('./helpers/Quill')['quillOptions']
  const quillToolbars: typeof import('./helpers/Quill')['quillToolbars']
  ...
  const reauthenticateWithCredential: typeof import('firebase/auth')['reauthenticateWithCredential']
  ...
  const setPersistence: typeof import('firebase/auth')['setPersistence']
  ...
  const sref: typeof import('firebase/storage')['ref']
  const storage: typeof import('firebase/storage')['getStorage']
  const stringToUrlConverter: typeof import('./helpers/Url')['stringToUrlConverter']
  ...
  const uploadString: typeof import('firebase/storage')['uploadString']
  const urlToStringConverter: typeof import('./helpers/Url')['urlToStringConverter']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly base64: UnwrapRef<typeof import('@hexagon/base64')['base64']>
    readonly browserSessionPersistence: UnwrapRef<typeof import('firebase/auth')['browserSessionPersistence']>
    ...
    readonly fileDialog: UnwrapRef<typeof import('file-dialog')['fileDialog']>
    readonly getContents: UnwrapRef<typeof import('@vueup/vue-quill')['getContents']>
    ...
    readonly limit: UnwrapRef<typeof import('firebase/firestore')['limit']>
    readonly makeDestructurable: UnwrapRef<typeof import('@vueuse/core')['makeDestructurable']>
    readonly markRaw: UnwrapRef<typeof import('vue')['markRaw']>
    readonly nextTick: UnwrapRef<typeof import('vue')['nextTick']>
    readonly onActivated: UnwrapRef<typeof import('vue')['onActivated']>
    readonly onAuthStateChanged: UnwrapRef<typeof import('firebase/auth')['onAuthStateChanged']>
    ...
    readonly orderBy: UnwrapRef<typeof import('firebase/firestore')['orderBy']>
    ...
    readonly reauthenticateWithCredential: UnwrapRef<typeof import('firebase/auth')['reauthenticateWithCredential']>
    ...
    readonly serverTimestamp: UnwrapRef<typeof import('firebase/firestore')['serverTimestamp']>
    readonly setDoc: UnwrapRef<typeof import('firebase/firestore')['setDoc']>
    readonly setPersistence: UnwrapRef<typeof import('firebase/auth')['setPersistence']>
