  ...
  <div id="finalEvaluation">
    <div class="d-flex flex-column gap-4 w-100" v-if="ready">
      ...
      <div
        ...
        v-if="userStore.user.appData.finalEvaluation"
      >
        <div class="border-bottom border-secondary">
        ...
        <div class="d-flex flex-column gap-4">
          <div
            class="col-12"
            v-for="(question, i) in Object(
              appStore.appCacheData[
                `${urlToStringConverter(
                  String(useRoute().params.playingContent)
                )}`
              ]
            ).data"
            :key="i"
            ...
            <div class="container">
              <div class="d-flex flex-column gap-2">
                <div class="d-flex fw-bolder gap-2">
                  ...
                  <div class="col text-wrap">
                    <div class="d-flex flex-column gap-2">
                      <div
                        class="col-12"
                        v-if="Object(question).questionImage !== ''"
                      >
                        <div class="col rounded-5 shadow overflow-hidden">
                          <img
                            :src="Object(question).questionImage"
                            alt=""
                            class="img-fluid"
                          />
                        </div>
                ...
                <div class="px-4">
                  <div class="d-flex flex-column gap-2">
                    <div class="d-flex flex-column gap-2">
                      <span class="text-capitalize"> Jawaban terpilih : </span>
                      <div
                        :class="[
                          'container bg-light border border-2 rounded py-2',
                          Object(question).trueAnswer ===
                          Object(userStore.user.appData.finalEvaluation)[
                            `${Object(question).id}`
                          ]
                    ...
                    <div class="d-flex flex-column gap-2">
                      <span class="text-capitalize"> kunci jawaban : </span>
                      <div
                        class="container bg-light text-success border border-success border-2 rounded py-2"
                      >
                        <div class="d-flex gap-2">
                          <div class="col-auto">
                            <span class="text-uppercase">
            ...
            <div class="d-flex flex-column gap-2">
              ...
              <div class="ps-4">
                <div
                  ...
                  v-for="(option, i) in Object(question).answerOption"
                  :key="i"
                >
                  <div class="col-auto">
                    <input
...
const sendEvaluation = () => {
  const question = Object(
    AppStore().appCacheData[
      `${urlToStringConverter(String(route.params.playingContent))}`
    ]
  ).data;
