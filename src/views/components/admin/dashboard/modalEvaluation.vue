<template>
  <div class="evaluation-modal p-5">
    <div class="container h-100">
      <div
        class="position-relative d-flex flex-column gap-3 rounded-9 h-100 bg-light shadow p-5"
      >
          ...
          >
            <div class="d-flex flex-column gap-3">
                ...
                >
                  <div class="col-auto">
                    <span
                      ...
                      @click="updateTrueAnswer(i, alphabet)"
                    >
                      {{ alphabet }}.
                    </span>
                  </div>
                  <div class="col">
                    <input
                      ...
                      @input="
                        (event) =>
                          updateOptions(i, alphabet, Object(event).target.value)
                      "
                    />
                  </div>
                </div>
              ...
              <div class="col-auto" style="width: fit-content">
                <button
                  class="button-style bg-danger small p-1 px-2"
