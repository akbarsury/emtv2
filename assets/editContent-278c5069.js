 ...
 */const pe="firebasestorage.googleapis.com",fe="storageBucket",Xe=2*60*1e3,Ke=10*60*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class U{constructor(e,s){this._service=e,s instanceof b?this._location=s:this._location=b.makeFromUrl(s,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,s){return new U(e,s)}get root(){const e=new b(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Te(this._location.path)}get storage(){return this._service}get parent(){const e=vt(this._location.path);if(e===null)return null;const s=new b(this._location.bucket,e);return new U(this._service,s)}_throwIfRoot(e){if(this._location.path==="")throw lt(e)}}function Xt(t,e,s){t._throwIfRoot("uploadBytes");const n=Vt(t.storage,t._location,ye(),new C(e,!0),s);return t.storage.makeRequestWithTokens(n,Oe).then(o=>({metadata:o,ref:t}))}function Kt(t){t._throwIfRoot("getDownloadURL");const e=$t(t.storage,t._location,ye());return t.storage.makeRequestWithTokens(e,Oe).then(s=>{if(s===null)throw it();return s})}function Gt(t,e){const s=Nt(t._location.path,e),n=new b(t._location.bucket,s);return new U(t.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ue="storage";function en(t,e,s){return t=$(t),Xt(t,e,s)}function tn(t){return t=$(t),Kt(t)}function ae(t,e){return t=$(t),Zt(t,e)}function le(t=Be(),e){t=$(t);const n=xe(t,Ue).getImmediate({identifier:e}),o=Le("storage");return o&&nn(n,...o),n}function nn(t,e,s,n={}){Jt(t,e,s,n)}function sn(t,{instanceIdentifier:e}){const s=t.getProvider("app").getImmediate(),n=t.getProvider("auth-internal"),o=t.getProvider("app-check-internal");return new ee(s,n,o,e,Pe)}function on(){Ne(new De(Ue,sn,"PUBLIC").setMultipleInstances(!0)),te(re,ie,""),te(re,ie,"esm2017")}on();const rn={uploadContentImage:(t,e)=>new Promise((s,n)=>{const o=ae(le(),`images/content/${t}.png`);en(o,e,{contentType:"image/png"}).then(async()=>{const r=await tn(ae(le(),`images/content/${t}.png`));s(r)}).catch(()=>n(!1))})},an=[[{header:[1,2,3,4,5,6,!1]}],[{size:["small",!1,"large","huge"]}],[{font:[]}],["bold","italic","underline","strike"],[{align:[]}],[{list:"ordered"},{list:"bullet"}],[{color:[]},{background:[]}],[{script:"sub"},{script:"super"}],[{indent:"-1"},{indent:"+1"}],[{direction:"rtl"}],["link","blockquote","image","video","code-block"],["clean"]],ln=[{name:"imageUploader",module:he,options:{upload:t=>new Promise((e,s)=>{rn.uploadContentImage(t.name,t).then(n=>{e(n)}).catch(n=>{alert("upload gagal"),s(n)})})}}],cn=ue({__name:"QuillEditor",props:{quillContent:{}},setup(t){const e=W(Object(Object.values(Object(Object.entries(Object(f().appCacheData[`${f().activeContent.data.name}`].subContent)[`${f().appCacheData[`${f().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(M().query.page)-1][1]))[0])),s=W(),n=()=>{e.value.data.ops=s.value.getContents().ops,f().updatePageContent()};return(o,r)=>{const i=Me("QuillEditor",!0);return X(),K("div",null,[de(i,{ref_key:"quill",ref:s,toolbar:"quillToolbars"in o?o.quillToolbars:m(an),modules:"quillModules"in o?o.quillModules:m(ln),content:o.quillContent.delta,"onUpdate:content":[r[0]||(r[0]=a=>o.quillContent.delta=a),r[1]||(r[1]=a=>n())]},null,8,["toolbar","modules","content"])])}}});const x=t=>(He("data-v-57123803"),t=t(),Ve(),t),un={key:0,class:"d-flex flex-column gap-4 p-4"},dn={class:"container-fluid border-secondary border-bottom py-2"},hn={class:"row align-items-center gap-2"},pn={class:"col-auto p-1"},fn=x(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," konten ")])],-1)),gn={class:"text-uppercase badge badge-secondary"},_n={class:"col-auto p-1"},mn=x(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," subkonten ")])],-1)),bn={class:"text-uppercase badge badge-secondary"},Rn={class:"col-auto p-1"},wn=x(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," halaman ")])],-1)),Tn={class:"text-uppercase badge badge-secondary"},yn={class:"col-auto p-1"},An=x(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," status ")])],-1)),En={class:"text-uppercase badge badge-secondary"},kn={class:"editor-content d-flex justify-content-center"},Cn={class:"editor-wrapper col-12 col-md-10 col-lg-8 bg-light rounded-5"},On={key:1,class:"p-4"},In=x(()=>u("span",{class:"loader"},null,-1)),Un=[In],vn=ue({__name:"editContent",setup(t){const e=W(Object(Object.values(Object(Object.entries(Object(f().appCacheData[`${f().activeContent.data.name}`].subContent)[`${f().appCacheData[`${f().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(M().query.page)-1][1]))[0])),s=$e({updating:!1,updated:!1,html:"<div> </div>",delta:new je(e.value.data)});return(n,o)=>{const r=cn;return("AppStore"in n?n.AppStore:m(f))().activeContent.data.name?(X(),K("div",un,[u("div",dn,[u("div",hn,[u("div",pn,[fn,u("span",gn,B(("AppStore"in n?n.AppStore:m(f))().activeContent.data.name),1)]),u("div",_n,[mn,u("span",bn,B(m(e).name),1)]),u("div",Rn,[wn,u("span",Tn,B(`${Number(("useRoute"in n?n.useRoute:m(M))().query.page)} - `+Object(Object.values(Object(Object.entries(Object(("AppStore"in n?n.AppStore:m(f))().appCacheData[`${("AppStore"in n?n.AppStore:m(f))().activeContent.data.name}`].subContent)[`${("AppStore"in n?n.AppStore:m(f))().appCacheData[`${("AppStore"in n?n.AppStore:m(f))().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(("useRoute"in n?n.useRoute:m(M))().query.page)-1][1]))[0]).name),1)]),u("div",yn,[An,u("span",En,B(m(s).updated?"diperbarui":"tidak diperbarui"),1)])])]),u("div",kn,[u("div",Cn,[de(r,{quillContent:m(s)},null,8,["quillContent"])])])])):(X(),K("div",On,Un))}}});const Dn=ze(vn,[["__scopeId","data-v-57123803"]]);export{Dn as default};
//# sourceMappingURL=editContent-278c5069.js.map
