 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ut(t,e,s){let n=1,o=null,r=null,i=!1,a=0;function l(){return a===2}let c=!1;function R(..._){c||(c=!0,e.apply(null,_))}function T(_){o=setTimeout(()=>{o=null,t(y,l())},_)}function w(){r&&clearTimeout(r)}function y(_,...S){if(c){w();return}if(_){w(),R.call(null,_,...S);return}if(l()||i){w(),R.call(null,_,...S);return}n<64&&(n*=2);let E;a===1?(a=2,E=0):E=(n+Math.random())*1e3,T(E)}let A=!1;function O(_){A||(A=!0,w(),!c&&(o!==null?(_||(a=2),clearTimeout(o),T(0)):_||(a=1)))}return T(0),r=setTimeout(()=>{i=!0,O(!0)},s),O}function dt(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ot(t){if(t.length===0)return null;const e=t.lastIndexOf("/");return e===-1?"":t.slice(0,e)}function St(t,e){const s=e.split("/").filter(n=>n.length>0).join("/");return t.length===0?s:t+"/"+s}function Te(t){const e=t.lastIndexOf("/",t.length-2);return e===-1?t:t.slice(e+1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
\r
`,w=`\r
--`+l+"--",y=C.getBlob(T,n,w);if(y===null)throw rt();const A={name:c.fullPath},O=J(r,t.host,t._protocol),_="POST",S=t.maxUploadRetryTime,I=new Ee(O,_,qt(t,s),S);return I.urlParams=A,I.headers=i,I.body=y.uploadData(),I.errorHandler=Ce(e),I}class zt{constructor(){this.sent_=!1,this.xhr_=new XMLHttpRequest,this.initXhr(),this.errorCode_=U.NO_ERROR,this.sendPromise_=new Promise(e=>{this.xhr_.addEventListener("abort",()=>{this.errorCode_=U.ABORT,e()}),this.xhr_.addEventListener("error",()=>{this.errorCode_=U.NETWORK_ERROR,e()}),this.xhr_.addEventListener("load",()=>{e()})})}send(e,s,n,o){if(this.sent_)throw N("cannot .send() more than once");if(this.sent_=!0,this.xhr_.open(s,e,!0),o!==void 0)for(const r in o)o.hasOwnProperty(r)&&this.xhr_.setRequestHeader(r,o[r].toString());return n!==void 0?this.xhr_.send(n):this.xhr_.send(),this.sendPromise_}getErrorCode(){if(!this.sent_)throw N("cannot .getErrorCode() before sending");return this.errorCode_}getStatus(){if(!this.sent_)throw N("cannot .getStatus() before sending");try{return this.xhr_.status}catch{return-1}}getResponse(){if(!this.sent_)throw N("cannot .getResponse() before sending");return this.xhr_.response}getErrorText(){if(!this.sent_)throw N("cannot .getErrorText() before sending");return this.xhr_.statusText}abort(){this.xhr_.abort()}getResponseHeader(e){return this.xhr_.getResponseHeader(e)}addUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.addEventListener("progress",e)}removeUploadProgressListener(e){this.xhr_.upload!=null&&this.xhr_.upload.removeEventListener("progress",e)}}class Xt extends zt{initXhr(){this.xhr_.responseType="text"}}function Ie(){return new Xt}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class v{constructor(e,s){this._service=e,s instanceof b?this._location=s:this._location=b.makeFromUrl(s,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,s){return new v(e,s)}get root(){const e=new b(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Te(this._location.path)}get storage(){return this._service}get parent(){const e=Ot(this._location.path);if(e===null)return null;const s=new b(this._location.bucket,e);return new v(this._service,s)}_throwIfRoot(e){if(this._location.path==="")throw lt(e)}}function Wt(t,e,s){t._throwIfRoot("uploadBytes");const n=Vt(t.storage,t._location,ye(),new C(e,!0),s);return t.storage.makeRequestWithTokens(n,Ie).then(o=>({metadata:o,ref:t}))}function Kt(t){t._throwIfRoot("getDownloadURL");const e=$t(t.storage,t._location,ye());return t.storage.makeRequestWithTokens(e,Ie).then(s=>{if(s===null)throw it();return s})}function Gt(t,e){const s=St(t._location.path,e),n=new b(t._location.bucket,s);return new v(t.storage,n)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ve="storage";function en(t,e,s){return t=$(t),Wt(t,e,s)}function tn(t){return t=$(t),Kt(t)}function ae(t,e){return t=$(t),Zt(t,e)}function le(t=Be(),e){t=$(t);const n=Le(t,ve).getImmediate({identifier:e}),o=xe("storage");return o&&nn(n,...o),n}function nn(t,e,s,n={}){Jt(t,e,s,n)}function sn(t,{instanceIdentifier:e}){const s=t.getProvider("app").getImmediate(),n=t.getProvider("auth-internal"),o=t.getProvider("app-check-internal");return new ee(s,n,o,e,De)}function on(){Se(new Ne(ve,sn,"PUBLIC").setMultipleInstances(!0)),te(re,ie,""),te(re,ie,"esm2017")}on();const rn={uploadContentImage:(t,e)=>new Promise((s,n)=>{const o=ae(le(),`images/content/${t}.png`);en(o,e,{contentType:"image/png"}).then(async()=>{const r=await tn(ae(le(),`images/content/${t}.png`));s(r)}).catch(()=>n(!1))})},an=[[{header:[1,2,3,4,5,6,!1]}],[{size:["small",!1,"large","huge"]}],[{font:[]}],["bold","italic","underline","strike"],[{align:[]}],[{list:"ordered"},{list:"bullet"}],[{color:[]},{background:[]}],[{script:"sub"},{script:"super"}],[{indent:"-1"},{indent:"+1"}],[{direction:"rtl"}],["link","blockquote","image","video","code-block"],["clean"]],ln=[{name:"imageUploader",module:he,options:{upload:t=>new Promise((e,s)=>{rn.uploadContentImage(t.name,t).then(n=>{e(n)}).catch(n=>{alert("upload gagal"),s(n)})})}}],cn=ue({__name:"QuillEditor",props:{quillContent:{}},setup(t){const e=X(Object(Object.entries(p().appCacheData[`${p().activeContent.data.name}`].subContent[`${p().appCacheData[`${p().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(M().query.page)-1][1])),s=X(),n=()=>{e.value.data.ops=s.value.getContents().ops,p().updatePageContent()};return(o,r)=>{const i=Me("QuillEditor",!0);return W(),K("div",null,[de(i,{ref_key:"quill",ref:s,toolbar:"quillToolbars"in o?o.quillToolbars:f(an),modules:"quillModules"in o?o.quillModules:f(ln),content:o.quillContent.delta,"onUpdate:content":[r[0]||(r[0]=a=>o.quillContent.delta=a),r[1]||(r[1]=a=>n())]},null,8,["toolbar","modules","content"])])}}});const L=t=>(je("data-v-c87fb359"),t=t(),Ve(),t),un={key:0,class:"d-flex flex-column gap-4 p-4"},dn={class:"container-fluid border-secondary border-bottom py-2"},hn={class:"row align-items-center gap-2"},pn={class:"col-auto p-1"},fn=L(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," konten ")])],-1)),gn={class:"text-uppercase badge badge-secondary"},_n={class:"col-auto p-1"},mn=L(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," subkonten ")])],-1)),bn={class:"text-uppercase badge badge-secondary"},Rn={class:"col-auto p-1"},wn=L(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," halaman ")])],-1)),Tn={class:"text-uppercase badge badge-secondary"},yn={class:"col-auto p-1"},An=L(()=>u("div",{class:"text-uppercase small"},[u("span",{class:"badge badge-primary"},[u("u",null," status ")])],-1)),En={class:"text-uppercase badge badge-secondary"},kn={class:"editor-content d-flex justify-content-center"},Cn={class:"editor-wrapper col-12 col-md-10 col-lg-8 bg-light rounded-5"},In={key:1,class:"p-4"},Un=L(()=>u("span",{class:"loader"},null,-1)),vn=[Un],On=ue({__name:"editContent",setup(t){const e=X(Object(Object.entries(p().appCacheData[`${p().activeContent.data.name}`].subContent[`${p().appCacheData[`${p().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(M().query.page)-1][1])),s=$e({updating:!1,updated:!1,html:"<div> </div>",delta:new He(e.value.data)});return(n,o)=>{const r=cn;return("AppStore"in n?n.AppStore:f(p))().activeContent.data.name?(W(),K("div",un,[u("div",dn,[u("div",hn,[u("div",pn,[fn,u("span",gn,B(("AppStore"in n?n.AppStore:f(p))().activeContent.data.name),1)]),u("div",_n,[mn,u("span",bn,B(("AppStore"in n?n.AppStore:f(p))().appCacheData[`${("AppStore"in n?n.AppStore:f(p))().activeContent.data.name}`].subContent[`${("AppStore"in n?n.AppStore:f(p))().appCacheData[`${("AppStore"in n?n.AppStore:f(p))().activeContent.data.name}`].lastSelectedSubContent}`].name),1)]),u("div",Rn,[wn,u("span",Tn,B(`${Number(("useRoute"in n?n.useRoute:f(M))().query.page)} - `+Object(Object.entries(("AppStore"in n?n.AppStore:f(p))().appCacheData[`${("AppStore"in n?n.AppStore:f(p))().activeContent.data.name}`].subContent[`${("AppStore"in n?n.AppStore:f(p))().appCacheData[`${("AppStore"in n?n.AppStore:f(p))().activeContent.data.name}`].lastSelectedSubContent}`].page)[Number(("useRoute"in n?n.useRoute:f(M))().query.page)-1][1]).name),1)]),u("div",yn,[An,u("span",En,B(f(s).updated?"diperbarui":"tidak diperbarui"),1)])])]),u("div",kn,[u("div",Cn,[de(r,{quillContent:f(s)},null,8,["quillContent"])])])])):(W(),K("div",In,vn))}}});const Nn=ze(On,[["__scopeId","data-v-c87fb359"]]);export{Nn as default};
//# sourceMappingURL=editContent-3175d4dc.js.map
